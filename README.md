...
| --- | --- | --- |
| Fabric | Client and server | `minecraft-tunnel-0.2.1+26.1.2+fabric.jar` |
| Forge | Client and server | `minecraft-tunnel-0.2.1+26.1.2+forge.jar` |
| NeoForge | Client and server | `minecraft-tunnel-0.2.1+26.1.2+neoforge.jar` |
| Ignite | Server | `minecraft-tunnel-0.2.1+26.1.2+ignite.jar` |
